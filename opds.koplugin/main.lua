...
function OPDS:init()
    ...
    self.settings.excluded_authors = self.opds_settings:readSetting("excluded_authors", {})
    self.settings.excluded_categories = self.opds_settings:readSetting("excluded_categories", {})
